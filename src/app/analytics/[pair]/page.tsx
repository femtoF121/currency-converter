...
export default async function AnalyticsPage({ params, searchParams }: Props) {
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b-2 pb-6">
        <div>
          <Link
            href="/"
      ...
      <section className="bg-white p-6 rounded-3xl border shadow-sm h-110">
